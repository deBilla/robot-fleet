...
func (m *mockRedis) CheckCommandDedup(_ context.Context, _ string) (int64, error)    { return 0, nil }
func (m *mockRedis) SetCommandDedup(_ context.Context, _ string, _ int64) error      { return nil }
